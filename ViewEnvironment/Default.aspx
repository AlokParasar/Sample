    ...
    <div class="row">
        ...
        <div class="row">
            <div class="large-12 columns">
                <div class="panel">
                    ...
                    <p>The Redis Data is <em>
                        <asp:Label ID="lblRedisData" runat="server"></asp:Label></em></p>
                </div>
                <hr/>
            </div>
        </div>
        ...
        <div class="row">
            <div class="large-12 columns">
                ...
                <asp:Button ID="btnKill" runat="server" Text="Redis Data" CssClass="medium alert button" OnClick="btnKill_Click"/>
            </div>
        </div>
